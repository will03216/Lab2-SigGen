...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    SData/*8:0*/ __Vdlyvdim0__sigdelay__DOT__ram_inst__DOT__ram_array__v0;
    CData/*7:0*/ __Vdlyvval__sigdelay__DOT__ram_inst__DOT__ram_array__v0;
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__ram_inst__DOT__ram_array__v0;
    // Body
    __Vdlyvset__sigdelay__DOT__ram_inst__DOT__ram_array__v0 = 0U;
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__ram_inst__DOT__ram_array
            [(0x1ffU & ((IData)(vlSelf->sigdelay__DOT__wr_addr) 
                        - (IData)(vlSelf->offset)))];
    }
    if (vlSelf->wr) {
        __Vdlyvval__sigdelay__DOT__ram_inst__DOT__ram_array__v0 
            = vlSelf->mic_signal;
        __Vdlyvset__sigdelay__DOT__ram_inst__DOT__ram_array__v0 = 1U;
        __Vdlyvdim0__sigdelay__DOT__ram_inst__DOT__ram_array__v0 
            = vlSelf->sigdelay__DOT__wr_addr;
    }
    if (__Vdlyvset__sigdelay__DOT__ram_inst__DOT__ram_array__v0) {
        vlSelf->sigdelay__DOT__ram_inst__DOT__ram_array[__Vdlyvdim0__sigdelay__DOT__ram_inst__DOT__ram_array__v0] 
            = __Vdlyvval__sigdelay__DOT__ram_inst__DOT__ram_array__v0;
    }
}
